...
export const PROJECTS: Project[] = [
  {
    ...
    metric: { value: "1", label: "port surfaces · everything else stays submerged" },
  ...
  },
  {
    ...
    metric: { value: "0", label: "state changes without an explicit confirm" },
  ...
  },
  {
    ...
    metric: { value: "4", label: "separate books, one model, one hard stop" },
  ...
  },
  {
    ...
    metric: { value: "0", label: "packets leave if the tunnel drops" },
  ...
  },
  {
    ...
    metric: { value: "O(1)", label: "coalescing — the free list is address-ordered" },
    tags: ["C", "POSIX", "sbrk"],
